...
function BookingContent() {
  ...
  if (!jadwal) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        ...
        <Link href="/cari-jadwal" className="text-blue-600 hover:underline">
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <Link href="/cari-jadwal" className="text-blue-600 hover:underline mb-6 inline-flex items-center gap-2">
        <ArrowLeft className="w-4 h-4" />
        Kembali ke Pencarian
      </Link>

      <h1 className="text-3xl font-bold mb-2 text-gray-900">
        Form <span className="text-blue-600">Pemesanan</span>
      </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="bg-[#fdfcfa] border border-[#e0dcd7] rounded-2xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <p className="text-blue-600 font-bold mt-2">{formatRupiah(jadwal.harga)}/orang</p>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <p className="text-blue-600 font-bold mt-2">{formatRupiah(jadwal.harga * jadwal.kapasitas)} (penuh)</p>
                </button>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input type="text" name="nama" value={formData.nama} onChange={handleChange}
                    ...
                    className="w-full bg-[#fdfcfa] border border-[#d4cfc8] rounded-lg px-4 py-3 text-gray-900 placeholder-gray-500 focus:border-blue-600 focus:outline-none focus:ring-1 focus:ring-blue-600" />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea name="alamatJemput" value={formData.alamatJemput} onChange={handleChange}
                    ...
                    className="w-full bg-[#fdfcfa] border border-[#d4cfc8] rounded-lg px-4 py-3 text-gray-900 placeholder-gray-500 focus:border-blue-600 focus:outline-none focus:ring-1 focus:ring-blue-600 resize-none" />
                </div>
                <div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-[#fdfcfa] border border-[#e0dcd7] rounded-2xl p-6 sticky top-24 shadow-sm">
            <h3 className="font-bold text-lg mb-4 text-blue-600">Ringkasan Pesanan</h3>
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between gap-3">
                ...
                <span className="text-blue-600 font-bold">{jadwal.jamBerangkat}</span>
              </div>
              <div className="flex justify-between gap-3">
